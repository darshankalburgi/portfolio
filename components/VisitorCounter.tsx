  ...
  if (variant === 'floating') {
    return (
      <motion.div
        ...
        className="fixed top-28 right-4 md:right-8 z-40"
      >
        <div className="relative group">
          ...
          {/* Main card */}
          <div className="relative glass border border-white/10 rounded-xl px-5 py-3 backdrop-blur-xl bg-white/5 shadow-lg">
                ...
                <AnimatePresence mode="wait">
                  {isLoading ? (
                    <motion.div
                      ...
                      animate={{ opacity: 1 }}
                      exit={{ opacity: 0 }}
                      className="h-5 w-16 bg-white/5 rounded animate-pulse"
                    />
                  ) : (
                    <motion.span
                      key={displayCount}
                      ...
                      exit={{ opacity: 0, y: 10 }}
                      className="text-xl font-bold text-gray-200 leading-none"
                    >
